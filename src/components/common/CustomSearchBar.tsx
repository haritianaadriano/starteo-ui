    ...
    <div>
      <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="relative isolate overflow-hidden px-6 py-20 text-center sm:px-16 sm:shadow-sm">
          <p className="mx-auto max-w-2xl font-bold tracking-tight text-gray-900 sm:text-2xl">
            Didn't find your project you were looking for?
          </p>

          <form action="/search">
            <label className="mx-auto relative bg-white min-w-sm max-w-2xl flex flex-col md:flex-row border py-2 px-2 rounded-2xl gap-2 shadow-2xl focus-within:border-gray-300">
              <input
                id="search-bar"
